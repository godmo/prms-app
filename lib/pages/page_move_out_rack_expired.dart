...
class PageMoveOutRackExpired extends StatefulWidget {
  final GlobalKey<GlobalNavBarState>? navBarKey;
  const PageMoveOutRackExpired({super.key, this.navBarKey});

  @override
  State<PageMoveOutRackExpired> createState() => _PageMoveOutRackExpiredState();
}

class _PageMoveOutRackExpiredState extends State<PageMoveOutRackExpired> {
  /// 控制相機掃描功能的控制器
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      SizedBox(width: 8),
                                      Text(
                                        'Flow Stage ( Move Out Rack - Expired)',
                          ...
                          page_stage == "Complete"
                              ? Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Move Out Rack(Expired) Information',
                                      style: TextStyle(
                                        fontSize: 16,
                                                                  ...
                                                                  (context) => CupertinoAlertDialog(
                                                                    title: Row(
                                                                      children: [
                                                                        ...
                                                                        SizedBox(width: 8),
                                                                        Text('Move Out Rack(Expired) Success'),
                                                                      ],
                                                                    ),
                                                                  ...
                                                                  (context) => CupertinoAlertDialog(
                                                                    title: Row(
                                                                      children: [
                                                                        ...
                                                                        SizedBox(width: 8),
                                                                        Text('Move Out Rack(Expired) Fail'),
                                                                      ],
                                                                    ),
