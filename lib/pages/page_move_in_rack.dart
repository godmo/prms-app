...
class PageMoveInRack extends StatefulWidget {
  ...
  const PageMoveInRack({super.key, this.navBarKey});

  @override
  State<PageMoveInRack> createState() => _PageMoveInRackState();
}

class _PageMoveInRackState extends State<PageMoveInRack> {
  /// 控制相機掃描功能的控制器
