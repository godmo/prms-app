...
class PageMoveOutRackPm extends StatefulWidget {
  final GlobalKey<GlobalNavBarState>? navBarKey;
  const PageMoveOutRackPm({super.key, this.navBarKey});

  @override
  State<PageMoveOutRackPm> createState() => _PageMoveOutRackPmState();
}

class _PageMoveOutRackPmState extends State<PageMoveOutRackPm> {
  /// 控制相機掃描功能的控制器
