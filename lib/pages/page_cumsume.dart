...
class _PageFun1State extends State<PageCunsume> {
  ...
  String page_stage = "User"; // User , Machine , Old_PR , Old_Tube ,Nozzle, New_PR, New_Tube , Complete
          ...
          if (page_stage == "User") {
            ...
            if (code1.isNotEmpty && code2.isNotEmpty && code3.isNotEmpty) {
              setState(() {
                ...
                //if (PrmsDataCheck.isValidPrId(p_new_pr_id)) {
                if (mounted && !_isDisposed) {
                  setState(() {
                    page_stage = "New_Tube";
                  });
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      page_stage == "User"
                                          ...
                                          : page_stage == "Old_PR"
                                          ? Row(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.science, size: 28, color: Color(0xFFB8860B))])
                                          : page_stage == "Old_Tube"
                                          ? Row(mainAxisSize: MainAxisSize.min, children: [Icon(CupertinoIcons.tag, size: 28, color: Color(0xFFB8860B))])
                                          : page_stage == "Nozzle"
                                          ? Row(
                                          ...
                                          onTap:
                                              _isSubmitting
                                                  ...
                                                  : () async {
                                                    ...
                                                    // 构建提交数据
                                                    final postBody = {
                                                      "url": ApiConfig.cumsumeSubmitUrl,
                                                      "body": {
                                                        "user_id": p_user_id,
                                                        "machine_id": p_machine_id,
                                                        "old_pr_id": p_old_pr_id,
                                                        "tube_id": p_old_tube_id,
                                                        "new_pr_id": p_new_pr_id,
                          ...
                          SizedBox(height: 16),
                          if (page_stage == "Old_PR" || page_stage == "New_PR")
